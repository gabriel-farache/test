...
# project_name is 'prj-iac-team-pp'
# pipeline_account is 'sa-pipeline@-a87865c181efbb2660ba1a1f.iam.gserviceaccount.com'


app_environment                 = "preprod" # Application environment, ie preprod/prod
...
cloud_run_service_vpc_connector = "projects/prj-pp-gen-preprod-net-acc7/locations/us-central1/connectors/preprod-gen-central1-02" # The VPC Network Connector that this cloud run can connect to. The Cloud Run Service Agent requires access to the host project's VPC connector, see requirements. See https://github.com/gcp/tfm-cloud-run#other-requirements for valid values.
gcp_project_id                  = "-a87865c181efbb2660ba1a1f" # The ID of the project in which the resource belongs. If it is not provided, the default is used.
