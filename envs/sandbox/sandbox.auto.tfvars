...
# project_name is 'prj-iac-team-s'
# pipeline_account is 'sa-pipeline@-123.iam.gserviceaccount.com'


app_environment                 = "sandbox" # Application environment, ie preprod/prod
...
gcp_project_id                  = "-123" # The ID of the project in which the resource belongs. If it is not provided, the default is used.
